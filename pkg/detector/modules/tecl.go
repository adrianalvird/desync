...
type TECLDetector struct{}

func (d *TECLDetector) Name() string { return "TE.CL" }

func (d *TECLDetector) Detect(ctx context.Context, sess *session.Session,
